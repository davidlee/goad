...
which is a fact it observes, and not a judgement about whether trying again
would work.

With the status stated, a supervisor — `nix/module.nix`'s systemd unit is the one this
